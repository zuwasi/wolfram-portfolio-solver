"""Main window for the Theoretical Trading Portfolio Calculator (Mathematica-only)."""
...
class MainWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("Trading Portfolio Calculator — Mathematica Engine")
    ...
    def _update_diagnostics(
        ...
        # Engine info
        lines.append("<h3>Computation Engine</h3>")
        lines.append(
            "<p style='color:green'><b>All calculations performed by "
            "Wolfram Mathematica</b> via wolframscript.</p>"
        )
